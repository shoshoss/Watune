  ...
  def default_meta_tags
    {
      ...
      reverse: true,
      separator: '|',
      description: 'Watune（ウェーチュン）は、音声による前向きなメッセージを通じて、あなたと仲間に元氣を与え、日々の生活をより豊かにするサービスです。',
      keywords: 'Watune, ウェーチュン, 前向き, メッセージ, 音声, 元氣, 喜び, 共有, SNS, アプリ, Webアプリ, 音声アプリ, プラットフォーム',
